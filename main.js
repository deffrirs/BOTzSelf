...
sendButImage(anu.jid, teks, `� DEFFBOTz`, img,but = [{buttonId:`hallo`, 
...
sendButImage(anu.jid, teks, `� DEFFBOTz`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `See You Broo?👋!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
